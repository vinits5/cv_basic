...
class R2Image {
 public:
  ...
  // Added functions for convolution and calculating Gaussian Filter.
  void Convolve(int* width_idx, int* height_idx, int filter_size, double* filter);
  double* GaussianFilter(int filter_size, double* sigma);
